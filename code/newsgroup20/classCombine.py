...
def plotAllcombi():
    ...
    plt.savefig("pf1_macro_ng_rf.png")
...
def plotClusterAnalysis(macro, micro):
    ...
    plt.savefig("giniimp_cluster_ng.png")
...
if __name__ == "__main__":
    ...
    selector_type = ["giniimptf", "dfs", "ginidfs", "chi"]
